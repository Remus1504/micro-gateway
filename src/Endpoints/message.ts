import { Create } from '../controllers/message/createMessage';
import { Get } from '../controllers/message/getMessage';
import { Update } from '../controllers/message/updateMessage';
...
class MessageRoutes {
  ...
  public routes(): Router {
    ...
    this.router.put(
      ...
      Update.prototype.markSingleMessage,
    );
    this.router.put(
      '/message/mark-multiple-as-read',
      Update.prototype.markMultipleMessages,
    );
    return this.router;
  }
}
